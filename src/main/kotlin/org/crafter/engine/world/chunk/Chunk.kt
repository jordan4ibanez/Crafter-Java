...
//    var rotation: Float = 0f
    ...
    private val meshes: Array<String> = Array(8){""}

    private val stackHeight = 16
    /**
...
//    }
    ...
    private fun getMesh(stack: Int): String {
        return meshes[stack]
    }
...
//        println("setting block data! new value is $blockData at index $index")
     ...
     */
    private fun parseBlockID(input: Int): Int {
        // Clear out right 16 bits
        return input ushr 16 shl 16
    }

    private fun parseLightLevel(input: Int): Int {
    ...
    private fun parseBlockState(input: Int): Int {
     ...
     */
    private fun shiftBlock(input: Int): Int {
        return input shl 16
    }

    private fun shiftLight(input: Int): Int {
        return input shl 12
    }

    private fun shiftState(input: Int): Int {
        return input shl 8
    }
     ...
     */
    private fun combine(blockID: Int, light: Int, state: Int): Int {
